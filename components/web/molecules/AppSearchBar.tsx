...
// components
import AppSearchOptionButton from '@/components/web/atoms/AppSearchOptionButton';
import AppDateRange from '@/components/web/atoms/AppDateRange';
import AppCounter from '@/components/web/atoms/AppCounter';
import AppSearchOptionWrapper from '@/components/web/atoms/AppSearchOptionWrapper';
// data
...
const AppSearchBar: FC<IAppSearchBarProps> = ({
  ...
  // data
  // const [{ location, checkIn, checkOut, guests }, dispatch]:any = useDataContext();
