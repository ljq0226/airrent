...
// components
import AppClearButtonProps from '@/components/web/atoms/AppClearButton';
import AppNearby from '@/components/web/atoms/AppNearby';
import AppSearchOptionMobile from '@/components/web/atoms/AppSearchOptionMobile';
import AppMobileNavigation from '@/components/web/atoms/AppNavigationMobile';
// icons
