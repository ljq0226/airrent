...
// components
import AppLogo, { EAppLogo } from '@/components/web/atoms/AppLogo';
import AppSearchBar from '@/components/web/molecules/AppSearchBar';
import AppHeaderOption from '@/components/web/atoms/AppHeaderOption';
import AppSearchBarMobile from '@/components/web/molecules/AppSearchBarMobile';
// icons
import { GlobeAltIcon, MenuIcon, SearchIcon } from '@heroicons/react/outline';
import { UserCircleIcon } from '@heroicons/react/solid';
// typings
import { EHeaderOpions, IExploreNearby } from '@/types';
