    ...
    >
      <div className="px-4 py-12">
        <div className="relative py-12 bg-white rounded">
          ...
          <p className="mt-6 text-xl font-medium text-center text-gray-800 animate-bounce">
            Loading ...
          </p>
        </div>
      </div>
